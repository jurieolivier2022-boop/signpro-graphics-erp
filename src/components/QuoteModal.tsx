                      ...
                      <tr key={item.id} className="bg-white hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-1">
                            ...
                            <input 
                              type="number" 
                              value={(item.unitCost === null || item.unitCost === undefined || isNaN(item.unitCost)) ? '' : item.unitCost}
                          ...
                          {isArea && (
                            <span className="text-[8px] text-text-light font-black uppercase tracking-[0.2em] block mt-1 opacity-60">Calculated Area</span>
                          )}
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex flex-col">
                            <span className="text-sm font-black text-text-main tabular-nums italic">
                              R{(item.totalPrice || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </span>
                            {isArea && (
